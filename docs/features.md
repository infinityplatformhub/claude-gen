...
### Status Reports (เป็นกฎเสมอ — hook-enforcement เป็นตัวเลือก)
...
| Phase | สิ่งที่ทำ |
|-------|---------|
| 0 | **Preferences ก่อนทุกอย่าง** — ภาษา + commit mode + auto-skill + status-report enforcement ในคำถามเดียว จากนั้นทุกข้อความเป็นภาษาที่เลือก |
| 1 | อ่าน codebase ทั้งหมด — detect ALL stacks (รองรับ mono repo) |
| 2 | แสดงสิ่งที่ detect ได้ ถามสูงสุด 5 คำถาม (มี default ให้ทุกข้อ ตอบ "ok" ได้เลย; ข้อ 5 = Contract-First API ถามเฉพาะเมื่อเจอ backend) |
